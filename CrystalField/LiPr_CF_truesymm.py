...
# best eXi fit, includes energy modes from ab initio theory and FIRMS
#####################################################################################################################################################################
...
params['B4_3'].set(value = B4_3, vary = False)
params['B63'].set(value = B63, vary = False)
params['B6_3'].set(value = B6_3, vary = False)
params['B6_6'].set(value = B6_6, vary = False)
...
energies = [0,0,266,266,269,269,396,396,676,676]
